...
const SideBar = () => {
  return (
    <div class="bg-blue-100 px-3">
      <button
        data-collapse-toggle="open_sidebar"
        type="button"
        class=" w-full bg-white rounded-none p-2  text-sm text-gray-500 my-3 text-center md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        aria-controls="open_sidebar"
        aria-expanded="false"
      >
        Edit Filter
      </button>
      <div id="open_sidebar" class="hidden  md:block ">
